...
const GamePage = () => {
    ...
    const { centerView, centerItemAlign, rowFormat, font50, alignRight, width20, width40, width30, width50, width60, width70 } = Styles;
    const { marginMDRight, marginMDTop, marginXSLeft, marginXSRight } = MarginStyles;
    const { paddingMDTop, paddingMDLeft, paddingMDBottom, paddingMDRight } = PaddingStyles;
    ...
    return (
        <View style={centerView}>
            <View style={[paddingMDLeft, paddingMDTop, paddingMDBottom, centerItemAlign]}>
                <AppLogo />
            </View>
            <View style={[paddingMDTop, paddingMDBottom, rowFormat]}>
                <View style={[width50]}>
                {
                    winner ? <Winner name={winner} /> : isGameDraw ? <GameDraw /> : <WhoseTurnComp whoseTurn={whoseTurn} />
                }
                </View>
                ...
                <View style={[width20]}>
                    <IconButton iconName="gear" iconSize={25} onPress={() =>{
                        setShowDialog(true);
                    }}/>
                </View>
            </View>
            ...
            {
                winner && (
                    <StrikeComp className={strikeClass} />
                )
            }
            <Sounds 
            ...
            <Dialog.Container visible={showDialog}>
                ...
                <Dialog.Button label="Singel Player" onPress={() => {
                    setSinglePlayer(true);
                    resetOrNewGame();
                    setShowDialog(false);
                }} />
                <Dialog.Button label="Multi Player" onPress={() => {
